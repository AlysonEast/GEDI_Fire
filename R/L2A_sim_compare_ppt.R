...
#rgdal::writeOGR(L2A_spdf, dsn="G:/Thesis/Spatial/LiDAR", layer = "ALS_Compare_v3", driver = "ESRI Shapefile")
...
# rgdal::writeOGR(L2A_spdf_2, dsn="G:/Thesis/Spatial/LiDAR", layer = "ALS_Compare_v3_Rmvd", driver = "ESRI Shapefile")
# write.csv(L2A_compare1, "G:/Thesis/Spatial/LiDAR/errors_to_merge.csv")
...
error_summary2$daseline<-ifelse(error_summary2$Data_short=="Flags Removed*", paste0("Baseline"), paste0("Filters"))
...
RMSE_plot<-ggplot(subset(error_summary2, Data_short!="Slopes < 30"), aes(x=rh, y=RMSE, col=Data_short, alpha=0.25)) + 
  ...
  geom_point(aes(col=daseline), size=2) +geom_line(aes(col=daseline), size=2) + theme_pubr() + 
  scale_colour_manual(values=c("#287eb7", "#919191")) + 
  theme(
...
RMSEpct_plot<-ggplot(subset(error_summary2, Data_short!="Slopes < 30"), aes(x=rh, y=RMSEpct, col=Data_short, alpha=0.25)) + 
  ...
  geom_point(aes(col=daseline), size=2) +geom_line(aes(col=daseline), size=2) + theme_pubr() + 
  scale_colour_manual(values=c("#287eb7", "#919191")) +   theme(
...
ggpubr::ggarrange(Bias_plot, RMSE_plot, MAE_plot,
          ...
          nrow = 2, 
          common.legend = FALSE)
png(file="G:/Thesis/Figures/PowerPoint/Filtering_error_summary_grey.png", width=12, height=7, units = "in", res=120) #res in ppi 300dpi = 118 ppi
ggpubr::ggarrange(Bias_plot, RMSE_plot, MAE_plot,
                  Rsq_plot, RMSEpct_plot, MAEpct_plot,
                  ncol = 3, 
                  nrow = 2, 
...
collocate_error<-read.csv("G:/Thesis/Spatial/LiDAR/Error_Summary_GEO_v5.csv")
dim(collocate_error)
dim(error_summary2)
...
collocate_error<-subset(collocate_error, 
                        Data_short=="Geolocation Corrected*" | Data_short=="No Geolocation Correction")
...
RMSE_plot<-ggplot(collocate_error, aes(x=rh, y=RMSE, col=Data_short, alpha=0.25)) + 
  ...
  scale_colour_manual(values = c("#287eb7","#b5e08f")) + 
  theme(
    legend.position = "none",
    text = element_text(size = 20)
  ) + guides(alpha = "none") +
...
MAE_plot<-ggplot(collocate_error, aes(x=rh, y=MAE, col=Data_short, alpha=0.9)) + 
  scale_x_continuous(limits = c(0,105), expand = c(0,0), breaks = seq(0,100,25)) +
  scale_y_continuous (limits = c(2,8.2), expand = c(0,0), breaks = seq(0,8,2)) +
  geom_point(aes(col=Data_short), size=2) +geom_line(aes(col=Data_short), size=2) + theme_pubr() + 
  scale_colour_manual(values = c("#287eb7","#b5e08f")) + 
  theme(
...
#png(file="G:/Thesis/Figures/PowerPoint/Geolocation_error_summary.png", width=12, height=7, units = "in", res=120) #res in ppi 300dpi = 118 ppi
ggpubr::ggarrange(Bias_plot, RMSE_plot, MAE_plot,
                  Rsq_plot, RMSEpct_plot, MAEpct_plot,
                  ncol = 3, 
                  nrow = 2, 
...
#png(file="G:/Thesis/Figures/Final/Baseline_Error.png", width=6, height=8, units = "in", res=120) #res in ppi 300dpi = 118 ppi
ggpubr::ggarrange(
...
collocate_error[c(401:500),"rsq"]
diff<-collocate_error[c(1:100),"rsq"]-collocate_error[c(401:500),"rsq"]
plot(diff, ylim=c(0,0.3))
max(diff[12:100])
which.max(diff[12:100])+11
min((diff[12:99]))
which.min(diff[12:99])

collocate_error[c(1:100),c("rh","rsq")] #rh 27 for collocated
collocate_error[c(401:500),c("rh","rsq")] #rh 43 for uncollocated


collocate_error[c(1:100),"RMSE"]
collocate_error[c(401:500),"RMSE"]
diff<-collocate_error[c(1:100),"RMSE"]-collocate_error[c(401:500),"RMSE"]
par(mfrow=c(1,1))
plot(diff)
abline(v=10)
abline(h=0)
...
#png(file="G:/Thesis/Figures/Final/rh_error_dist_bins.png", width=5.5, height=4, units = "in", res=120) #res in ppi 300dpi = 118 ppi
out
dev.off()
...
RMSE_plot<-ggplot(subset(error_summary2, Data_short=="Flags Removed*"), aes(x=rh, y=RMSE, alpha=0.25), col="#1b63a5") + 
  scale_x_continuous(limits = c(0,105), expand = c(0,0), breaks = seq(0,100,25)) +
  scale_y_continuous (limits = c(2,7), expand = c(0,0), breaks = seq(0,6,2)) +
...
MAE_plot<-ggplot(subset(error_summary2, Data_short=="Flags Removed*"), aes(x=rh, y=MAE, col=Data_short, alpha=0.9)) + 
  scale_x_continuous(limits = c(0,105), expand = c(0,0), breaks = seq(0,100,25)) +
  scale_y_continuous (limits = c(2,7), expand = c(0,0), breaks = seq(0,8,2)) +
  geom_point(col="#1b63a5", size=2) +geom_line(col="#1b63a5", size=2) + theme_pubr() + 
  theme(
    legend.position = "none",
    text = element_text(size = 20)
  ) + guides(alpha = "none") +
...
MAEpct_plot<-ggplot(subset(error_summary2, Data_short=="Flags Removed*"), aes(x=rh, y=MAEpct, col=Data_short, alpha=0.9)) + 
  scale_x_continuous(limits = c(0,105), expand = c(0,0), breaks = seq(0,100,25)) +
  scale_y_continuous (limits = c(10,100), expand = c(0,0), breaks = seq(0,100,20)) +
  geom_point(col="#1b63a5", size=2) +geom_line(col="#1b63a5", size=2) + theme_pubr() + 
  theme(
...
ggarrange(Rsq_plot, RMSEpct_plot, 
          ...
          nrow = 2, 
          common.legend = FALSE)
png(file="G:/Thesis/Figures/PowerPoint/error_summary_1line.png", width=12, height=7, units = "in", res=120) #res in ppi 300dpi = 118 ppi
ggarrange(Bias_plot, RMSE_plot, MAE_plot,
          Rsq_plot, RMSEpct_plot, MAEpct_plot,
          ncol = 3,
          nrow = 2,
          common.legend = FALSE)
...
#png(file="G:/Thesis/Figures/Final/error_summary_geo_2lines.png", width=12, height=11, units = "in", res=120) #res in ppi 300dpi = 118 ppi
ggarrange(Rsq_plot, RMSEpct_plot, 
          Bias_plot, RMSE_plot,
          ncol = 2,
          nrow = 2, 
...
P5<-ggplot(L2A_compare1) + geom_point(aes(x=rh_5, y=rhGauss.5, color=d5)) + 
  geom_abline(intercept = 0, slope = 1, size=1) + scale_color_viridis() +
  theme_bw() + theme(legend.position = "none") +
  xlim(-10,8) + ylim(-10,10)+
  geom_hline(yintercept=0, linetype="dashed", color = "red", size=0.2)+ 
  geom_vline(xintercept=0, linetype="dashed", color = "red", size=0.2) +
  xlab("rh 5 (m)") + ylab("rh 5 (m)") + theme(text = element_text(size = 20))  
P75<-ggplot(L2A_compare1) + geom_point(aes(x=rh_75, y=rhGauss.75, color=d75)) + 
  geom_abline(intercept = 0, slope = 1, size=1) + scale_color_viridis() +
  theme_bw() + theme(legend.position = "none") +
  xlim(0,45) + ylim(0,50)+
  geom_hline(yintercept=0, linetype="dashed", color = "red", size=0.2)+ 
  geom_vline(xintercept=0, linetype="dashed", color = "red", size=0.2) +
  xlab("rh 75 (m)") + ylab("rh 75 (m)") + theme(text = element_text(size = 20))  
P50<-ggplot(L2A_compare1) + geom_point(aes(x=rh_50, y=rhGauss.50, color=d50)) + 
  geom_abline(intercept = 0, slope = 1, size=1) + scale_color_viridis() +
  theme_bw() + theme(legend.position = "none")+
  xlim(0,36) + ylim(0,40) +
  geom_hline(yintercept=0, linetype="dashed", color = "red", size=0.2)+ 
  geom_vline(xintercept=0, linetype="dashed", color = "red", size=0.2) +
  xlab("rh 50 (m)") + ylab("rh 50 (m)") + theme(text = element_text(size = 20))  
P25<-ggplot(L2A_compare1) + geom_point(aes(x=rh_25, y=rhGauss.25, color=d25)) + 
  geom_abline(intercept = 0, slope = 1, size=1) + scale_color_viridis() +
  theme_bw() + theme(legend.position = "none")+
  xlim(-5,27) + ylim(-5,35)+
  geom_hline(yintercept=0, linetype="dashed", color = "red", size=0.2)+ 
  geom_vline(xintercept=0, linetype="dashed", color = "red", size=0.2) +
  xlab("rh 25 (m)") + ylab("rh 25 (m)") + theme(text = element_text(size = 20))  
P98<-ggplot(L2A_compare1) + geom_point(aes(x=rh_98, y=rhGauss.98, color=d98)) + 
  geom_abline(intercept = 0, slope = 1, size=1) + scale_color_viridis() + 
  theme_bw() + theme(legend.position = "none") +
  xlim(0,53) + ylim(0,60)+
  geom_hline(yintercept=0, linetype="dashed", color = "red", size=0.2)+ 
  geom_vline(xintercept=0, linetype="dashed", color = "red", size=0.2) +
  xlab("rh 98 (m)") + ylab("rh 98 (m)")+ theme(text = element_text(size = 20))  


rh1x5<-ggarrange(P98, P75, P50, P25, P5,
                  ncol = 1, nrow = 5)
png(file="G:/Thesis/Figures/PowerPoint/GEDI_vs_GEDIsim_1x5.png", width=6, height=13.2, units = "in", res=120) #res in ppi 300dpi = 118 ppi
annotate_figure(rh1x5,
...
png(file="G:/Thesis/Figures/Final/GEDI_vs_GEDIsim_2x6.png", width=4.5, height=13.2, units = "in", res=120) #res in ppi 300dpi = 118 ppi
annotate_figure(rh2by5,
                top = text_grob("GEDI rh Values", size = 18), 
                left = text_grob(bquote('GEDI'['sim']*' rh Values'), size = 18, rot = 90))
dev.off()
...
geo_derrived<-read.csv("G:/Thesis/Spatial/LiDAR/Derrived_GEO_v3.csv")
...
#r_squared
cor(geo_derrived$rh_sum98, geo_derrived$rhGauss_sum98) #0.83
cor(geo_derrived$CR_sim, geo_derrived$CR_gedi) # 0.66
cor(geo_derrived$CR50_sim, geo_derrived$CR50_gedi) # 0.75
...
#RMSE
sqrt(mean((geo_derrived$rhGauss_sum98 - geo_derrived$rh_sum98)^2)) #423
sqrt(mean((geo_derrived$CR_gedi - geo_derrived$CR_sim)^2)) #0.16
sqrt(mean((geo_derrived$CR50_gedi - geo_derrived$CR50_sim)^2)) #0.18
...
#RMSE$
(sqrt(mean((geo_derrived$rhGauss_sum98 - geo_derrived$rh_sum98)^2)))/mean(geo_derrived$rhGauss_sum98)*100 #44%
(sqrt(mean((geo_derrived$CR_gedi - geo_derrived$CR_sim)^2)))/mean(geo_derrived$CR_sim)*100 #23%
(sqrt(mean((geo_derrived$CR50_gedi - geo_derrived$CR50_sim)^2)))/mean(geo_derrived$CR50_sim)*100 #34%
...
rh_sum<-ggplot(derrived) + geom_point(aes(x=rh_sum98, y=rhGauss_sum98, col=data, alpha=0.9), size=1.5) + 
  theme_pubr() + theme(legend.position = "none") +
  scale_x_continuous(limits = c(0,4150), expand = c(0,0), breaks = seq(0,4000,1000)) +
...
cr<-ggplot(derrived) + geom_point(aes(x=CR_gedi, y=CR_sim, col=data, alpha=0.9), size=1.5) + 
  theme_pubr() + theme(legend.position = "none") +
...
r<-ggplot(derrived) + geom_point(aes(x=R98_50_gedi, y=R98_50_sim, col=data, alpha=0.9), size=1.5) + 
  theme_pubr() + theme(legend.position = "none") +
  scale_x_continuous(limits = c(0,105), expand = c(0,0), breaks = seq(0,100,25)) +
  scale_y_continuous (limits = c(0,100), expand = c(0,0), breaks = seq(0,100,25)) +
  scale_color_manual(values = c("#2ca02c", "#892560"), labels = c("Geolocation Corrected", "No Correction")) +
...
#png(file="G:/Thesis/Figures/Final/Derrived_Metrics.png", width=9, height=4, units = "in", res=120) #res in ppi 300dpi = 118 ppi
annotate_figure(compound_error,
                bottom = text_grob("GEDI", size = 18), 
                left = text_grob(bquote('GEDI'['sim']), size = 18, rot = 90))
dev.off()
...
ggarrange(Rsq_plot, RMSEpct_plot, 
          ...
          nrow = 2, 
          common.legend = FALSE)
# #png(file="G:/Thesis/Figures/Final/Filtering_error_summary.png", width=12, height=11, units = "in", res=120) #res in ppi 300dpi = 118 ppi
# ggarrange(Rsq_plot, RMSEpct_plot,
#           Bias_plot, RMSE_plot,
#           ncol = 2,
#           nrow = 2,
