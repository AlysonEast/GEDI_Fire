...
setwd("/mnt/lustrefs/scratch/v38p156/L2A1/output")

#create a list of the files from your target directory
file_list <- list.files(path="/mnt/lustrefs/scratch/v38p156/L2A1/output")
...
for (i in 1:length(Region_list)){
  temp_data <- subset(gedilevel2a_spdf, region==Region_list[i])
  writeOGR(temp_data, dsn = paste0("/mnt/lustrefs/scratch/v38p156/Regions/", Region_list[i]), layer = paste0(Region_list[i],"_1"), driver = "ESRI Shapefile")
}
Sys.time()