...
# plot of differences
png(file="G:/Thesis/Figures/PowerPoint/change_NA.png", width=12, height=7, units = "in", res=120) #res in ppi 300dpi = 118 ppi
...
#  geom_vline(xintercept = 98, linetype ="dashed", col="red")+
#  geom_vline(xintercept = 50, linetype ="dashed", col="red")+
...
fig<-ggpubr::ggarrange(
  ggplot(data = Bonal_melt_trunk, aes(rh, value)) + 
    ...
    scale_color_manual(values = c("#018571", "#a6611a"), labels = c("Unburned", "Burned")) + 
    labs(col=" ") +labs(fill="") + xlab("")+ ylab("")+ theme(text = element_text(size = 20))  ,
...
#png(file="G:/Thesis/Figures/PowerPoint/GAMS_NA.png", width=12, height=7, units = "in", res=120) #res in ppi 300dpi = 118 ppi

annotate_figure(fig, left = text_grob("Height Return (m)", size=20, rot = 90, vjust = 2),
                bottom = text_grob(expression("Percent of total Wavefrom Energy"~("rh"['%'])), size=20, vjust = -.5))
dev.off()
...
png(file="G:/Thesis/Figures/PowerPoint/Accuracy_vs_diff_NA.png", width=7, height=5, units = "in", res=120) #res in ppi 300dpi = 118 ppi
...
dif + geom_line(data= error_plot, aes(x=rh, y=value, linetype=variable, size=variable)) +
  ...
  guides(linetype = guide_legend(nrow = 2)) + theme(text = element_text(size = 20))  

dev.off()

png(file="G:/Thesis/Figures/PowerPoint/Accuracy_vs_diff_NA_step4.png", width=7, height=5, units = "in", res=120) #res in ppi 300dpi = 118 ppi
dif + geom_line(data= error_plot, aes(x=rh, y=value, linetype=variable, size=variable)) +
  scale_linetype_manual(values=c("solid", "dotted", NA, "longdash"), labels = c("RMSE","Absolute Bias","MAE", "R-squared")) +
  scale_size_manual(values=c(.5, .8, 0, .5), labels = c("RMSE","Absolute Bias", "MAE", "R-squared")) +
  guides(linetype = guide_legend(nrow = 2)) 
dev.off()

png(file="G:/Thesis/Figures/PowerPoint/Accuracy_vs_diff_NA_step3.png", width=7, height=5, units = "in", res=120) #res in ppi 300dpi = 118 ppi
dif + geom_line(data= error_plot, aes(x=rh, y=value, linetype=variable, size=variable)) +
  scale_linetype_manual(values=c(NA, "dotted", NA, "longdash"), labels = c("RMSE","Absolute Bias","MAE", "R-squared")) +
  scale_size_manual(values=c(0, .8, 0, .5), labels = c("RMSE","Absolute Bias", "MAE", "R-squared")) +
  guides(linetype = guide_legend(nrow = 2)) 
dev.off()

png(file="G:/Thesis/Figures/PowerPoint/Accuracy_vs_diff_NA_step2.png", width=7, height=5, units = "in", res=120) #res in ppi 300dpi = 118 ppi
dif + geom_line(data= error_plot, aes(x=rh, y=value, linetype=variable, size=variable)) +
  scale_linetype_manual(values=c(NA, NA, NA, "longdash"), labels = c("RMSE","Absolute Bias","MAE", "R-squared")) +
  scale_size_manual(values=c(.5, .8, 0, .5), labels = c("RMSE","Absolute Bias", "MAE", "R-squared")) +
  guides(linetype = guide_legend(nrow = 2)) 
dev.off()

png(file="G:/Thesis/Figures/PowerPoint/Accuracy_vs_diff_NA_step1.png", width=7, height=5, units = "in", res=120) #res in ppi 300dpi = 118 ppi
dif + geom_line(data= error_plot, aes(x=rh, y=value, linetype=variable, size=variable)) +
  scale_linetype_manual(values=c(NA, NA, NA, NA), labels = c("RMSE","Absolute Bias","MAE", "R-squared")) +
  scale_size_manual(values=c(.5, .8, 0, .5), labels = c("RMSE","Absolute Bias", "MAE", "R-squared")) +
  guides(linetype = guide_legend(nrow = 2)) 
dev.off()

png(file="G:/Thesis/Figures/PowerPoint/Accuracy_vs_diff_NA_Benchmark.png", width=7, height=5, units = "in", res=120) #res in ppi 300dpi = 118 ppi
dif + geom_line(data= error_plot, aes(x=rh, y=value, linetype=variable, size=variable)) +
  scale_linetype_manual(values=c("solid", "dotted", "dashed", "longdash"), labels = c("RMSE","Absolute Bias","MAE", "R-squared")) +
  scale_size_manual(values=c(.5, .8, .75, .5), labels = c("RMSE","Absolute Bias", "MAE", "R-squared")) +
  geom_vline(xintercept = 98, col="red", linetype="dashed") +
...
p<-ggplot(subset(Full_melt_trunk, rh==0 | rh==5 | rh==10 |rh==15 |rh==20 |
  ...
  theme_pubr() + coord_flip() + theme(text = element_text(size = 20))  

png(file="G:/Thesis/Figures/PowerPoint/Density_bySiteAndBurn_rotate.png", width=10, height=8, units = "in", res=120) #res in ppi 300dpi = 118 ppi
p
dev.off()
...
# png(file="G:/Thesis/Figures/PowerPoint/LAI_NA2.png",
