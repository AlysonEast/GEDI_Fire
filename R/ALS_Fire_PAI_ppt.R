...
lai_plot<-ggplot(LAI_DF_sub, aes(value, fill=as.factor(Burned))) +
  ...
  geom_vline(data=mu, aes(xintercept = grp.mean, col=Burned), size=1) +
  ...
  facetted_pos_scales(x=list(LAI == "35 to 40"~scale_x_continuous(breaks = seq(0,.6,0.6)),
                             LAI == "30 to 35"~scale_x_continuous(breaks = seq(0,.6,0.6)),
                             LAI == "25 to 30"~scale_x_continuous(breaks = seq(0,0.6,0.6)),
                             LAI == "20 to 25"~scale_x_continuous(breaks = seq(0,1,0.5)),
                             LAI == "15 to 20"~scale_x_continuous(breaks = seq(0,1,1)),
                      ...
                      y=list(LAI == "45 to 50"~scale_y_continuous(breaks = seq(0,15000,5000)),
                             ...
                             LAI == "35 to 40"~scale_y_continuous(breaks = seq(0,100,100)),
                             LAI == "30 to 35"~scale_y_continuous(breaks = seq(0,8,8)),
                             LAI == "25 to 30"~scale_y_continuous(breaks = seq(0,5,5)),
                             LAI == "20 to 25"~scale_y_continuous(breaks = seq(0,3,3)),
                             LAI == "15 to 20"~scale_y_continuous(breaks = seq(0,3,3)),
                             LAI == "10 to 15"~scale_y_continuous(breaks = seq(0,3,2)),
                             LAI == "5 to 10"~scale_y_continuous(breaks = seq(0,1.5,1)),
...
#png(file="G:/Thesis/Figures/PowerPoint/LAI_diff.png",
