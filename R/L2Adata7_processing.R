...
setwd("/mnt/lustrefs/scratch/v38p156/L2Adata") #CHANGE HERE

#create a list of the files from your target directory
file_list <- list.files(path="/mnt/lustrefs/scratch/v38p156/L2Adata") #CHANGE HERE
...
for (i in 1:length(Region_list)){
  ...
  writeOGR(temp_data, dsn = paste0("/mnt/lustrefs/scratch/v38p156/Regions/", i), layer = paste0("L2A_",Region_list[i],"_7"), driver = "ESRI Shapefile") #CHANGE _##
}
Sys.time()